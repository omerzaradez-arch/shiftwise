...
המערכת אוכפת סיסמאות באורך לפחות 8 תווים. הסיסמה לעובדי הדמו ב-`seed.py`
היא `Demo1234!` (לכל המשתמשים). שנה אותה אצלך לפני שמשתמשים אמיתיים נכנסים.

| משתמש | טלפון | סיסמה | תפקיד |
|--------|-------|-------|--------|
| יוסי כהן | 0501111111 | Demo1234! | מנהל |
| שרה לוי | 0502222222 | Demo1234! | עובד בכיר |
| ריבה אברהם | 0504444444 | Demo1234! | עובד |
